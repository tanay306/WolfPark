...
public class Citation {
	...
	protected Citation(String citation_number, String citation_date, String citation_time, String category,
			String payment_status, String lot_name, String zone_id, String space_number) {
	...
	protected boolean containsAll(Statement statement, String lot_name, String zone_id, String space_number) {
		ResultSet result = null;
		String query = "Select * from space where lot_name = '" + lot_name + "'and zone_id = '" + zone_id
				+ "' and space_number = " + space_number + " and  availability_slot = 1;";
		try {
			result = statement.executeQuery(query);
			if (result.next()) {
				return true;
