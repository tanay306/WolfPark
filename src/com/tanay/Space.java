...
public class Space {
    ...
    protected boolean containsSpace(Statement statement) {
        ...
        String query = "SELECT * FROM space WHERE lot_name = '" + this.lot_name + "' AND zone_id = '" + this.zone_id
    ...
    protected void insert(Statement statement) {
        String query = "INSERT INTO space VALUES ('" + this.lot_name + "','" + this.zone_id + "','" + this.space_number
                + "','" + this.type + "','" + this.availability_slot + "');";
        System.out.println(query);
        try {
