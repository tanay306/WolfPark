...
public class Permit {
	...
	protected Permit(String permit_id, String start_date, String expiration_date, String expiration_time,
			String vehicle_id, String type) {
	...
	protected void insert(Statement statement) {
		String query = "INSERT INTO permit VALUES ('" + this.permit_id + "','" + this.start_date + "','"
